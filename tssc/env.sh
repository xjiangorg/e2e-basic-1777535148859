...
export IMAGE_URL=${IMAGE_URL-quay.io/quay_xjiang/e2e-basic-1777535148859:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/xjiangorg/e2e-basic-1777535148859-gitops
